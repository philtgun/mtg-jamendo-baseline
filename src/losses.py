# Taken from https://github.com/usc-sail/media-eval-2020
...
'''
Args:
input: A torch tensor of class predictions (logits if from_logits is True, else sigmoid outputs). Shape: (batch_size,
num_classes)
